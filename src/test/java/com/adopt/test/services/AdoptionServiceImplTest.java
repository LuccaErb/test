...
class AdoptionServiceImplTest {
    ...
    void getAdoptionByAdopterId() {
        ...
        when(adopterRepository.existsById(adopter.getId())).thenReturn(true); // Add this line

        List<AdoptionDto> result = adoptionService.getAdoptionByAdopterId(adopter.getId());
        assertNotNull(result);
